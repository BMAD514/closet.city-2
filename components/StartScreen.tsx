...
const StartScreen: React.FC<StartScreenProps> = ({ onModelFinalized, onBrowseAsGuest }) => {
      ...
      {!userImageUrl ? (
          ...
          <div className="lg:w-1/2 flex flex-col items-center lg:items-start text-center lg:text-left">
            <div className="max-w-lg">
              ...
              <div className="flex flex-col items-center lg:items-start w-full gap-3">
                <label htmlFor="image-upload-start" className="w-full relative flex items-center justify-center px-8 py-3 text-base font-semibold text-white bg-black rounded-md cursor-pointer group hover:bg-neutral-800 transition-colors">
                ...
                <button onClick={onBrowseAsGuest} className="w-full relative flex items-center justify-center px-8 py-3 text-base font-semibold text-neutral-700 bg-neutral-200 rounded-md cursor-pointer group hover:bg-neutral-300 transition-colors">
                  Browse the Collection
                </button>

                <p className="text-neutral-500 text-xs mt-1">By uploading, you agree not to create harmful, explicit, or unlawful content. This service is for creative and responsible use only.</p>
        ...
        >
          <div className="md:w-1/2 flex-shrink-0 flex flex-col items-center md:items-start">
            ...
            {error && 
              <div className="text-center md:text-left text-red-600 max-w-md mt-6">
                ...
                <button onClick={reset} className="text-sm font-semibold text-neutral-700 hover:underline">Try Again</button>
              </div>
            }
          ...
          <div className="md:w-1/2 w-full flex items-center justify-center">
            <div 
              className={`relative rounded-[1.25rem] transition-all duration-700 ease-in-out ${isGenerating ? 'border border-neutral-300 animate-pulse' : 'border border-transparent'}`}
            >
              <Compare
